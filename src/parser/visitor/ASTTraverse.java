...
public class ASTTraverse implements ASTVisitor
{
	...
	// ----------------------------------add by liuyuan-------------------------------------------------
	public void visitPre(ExpressionPoss e) throws PrismLangException { defaultVisitPre(e); }
	public Object visit(ExpressionPoss e) throws PrismLangException
	{
		visitPre(e);
		if (e.getProb() != null) e.getProb().accept(this);
		if (e.getExpression() != null) e.getExpression().accept(this);
	...
	public void visitPost(ExpressionPoss e) throws PrismLangException { defaultVisitPost(e); }
	// ----------------------------------to end!-------------------------------------------------
