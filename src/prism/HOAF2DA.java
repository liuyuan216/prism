...
import jhoafparser.AtomAcceptance;
import jhoafparser.AtomLabel;
import jhoafparser.BooleanExpression;
import jhoafparser.HOAConsumer;
import jhoafparser.HOAConsumerException;
import jhoafparser.ImplicitEdgeHelper;
...
public class HOAF2DA implements HOAConsumer {
	...
	//TODO add transition based acceptance
	...
	public void addEdgeImplicit(int stateId, List<Integer> conjSuccessors,
		...
		if (accSignature != null) {
			throw new HOAConsumerException("DA has transition-based acceptance (state "+stateId+", currently only state-labeled acceptance is supported");
		}
