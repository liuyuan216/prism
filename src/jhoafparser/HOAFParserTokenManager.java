/* Generated By:JavaCC: Do not edit this line. HOAFParserTokenManager.java */
package jhoafparser;
import java.io.*;
import java.util.*;

/** Token Manager. */
public class HOAFParserTokenManager implements HOAFParserConstants
{
...
/** Constructor. */
public HOAFParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public HOAFParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
