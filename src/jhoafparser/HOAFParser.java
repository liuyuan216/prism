/* Generated By:JavaCC: Do not edit this line. HOAFParser.java */
package jhoafparser;

import java.io.*;
import java.util.*;

public class HOAFParser implements HOAFParserConstants {
        //-----------------------------------------------------------------------------------
        // static member variables
        //-----------------------------------------------------------------------------------

        private static HOAFParser theParser = null;
        private static HOAConsumer consumer;
        ...
        /**
	 * Entry point for parsing HOAF files (with default settings).
	 ...
	 */
        ...
        /**
	 * Entry point for parsing HOAF files.
	 * <br> Note: this parser is non-reentrant, i.e., it is
	 * not possible to parse two streams at the same time!
	 *
	 * @param str The input stream with the automaton description
	 ...
	 */
        public static void parseHOA(InputStream str, HOAConsumer userConsumer, HOAFParserSettings settings) throws ParseException
        {
                // (Re)start parser
...
//-----------------------------------------------------------------------------------
  ...
  static final public void StateName() throws ParseException {
        BooleanExpression labelExpr = null;
        Integer state;
...
// Integer
  ...
  static public HOAFParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x7fc000,0x7fc000,0x1000000,0x0,0x2000000,0x1000000,0x800000,0x4000000,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x10000000,0x0,0x40000000,0x10000000,0x10000000,0x40000000,0x2000000,0x1000000,0x4800000,0x0,0x1000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x20,0x20,0x0,0x8,0x0,0x0,0x0,0x13,0x14,0x14,0x8,0x10,0x1c,0x1c,0x0,0x0,0x8,0x0,0x4,0x0,0x0,0x0,0x0,0x47,0x4,0x0,};
   }

  /** Constructor with InputStream. */
  public HOAFParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public HOAFParser(java.io.InputStream stream, String encoding) {
    ...
    token_source = new HOAFParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public HOAFParser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public HOAFParser(HOAFParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(HOAFParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
